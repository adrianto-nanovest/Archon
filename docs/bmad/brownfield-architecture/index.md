...
- [Archon Brownfield Architecture Document v3.0](#table-of-contents)
  ...
  - [Quick Reference - Key Files and Entry Points](./quick-reference-key-files-and-entry-points.md)
    ...
    - [Files Relevant to Confluence Integration](./quick-reference-key-files-and-entry-points.md#files-relevant-to-confluence-integration)
      ...
      - [Confluence Integration Files (Implemented)](./quick-reference-key-files-and-entry-points.md#confluence-integration-files-implemented)
  ...
  - [Data Models and APIs](./data-models-and-apis.md)
    - [Database Schema (SQL-based, No ORM!)](./data-models-and-apis.md#database-schema-sql-based-no-orm)
      - [Key Tables](./data-models-and-apis.md#key-tables)
        ...
        - [Confluence Tables (migration 901)](./data-models-and-apis.md#confluence-tables-migration-901)
    ...
    - [API Specifications](./data-models-and-apis.md#api-specifications)
      ...
      - [Confluence APIs](./data-models-and-apis.md#confluence-apis-confluence_apipy)
  ...
  - [Confluence Integration Architecture](./confluence-integration-architecture.md)
    ...
    - [Files Created (~2,100 lines total)](./confluence-integration-architecture.md#files-created-2100-lines-total)
  ...
  - [Recent Major Changes (August - October 2025)](./recent-major-changes-august-october-2025.md)
    - [1. Multi-LLM Provider Ecosystem ✅ IMPLEMENTED](./recent-major-changes-august-october-2025.md#1-multi-llm-provider-ecosystem-implemented)
    - [2. Migration Tracking System ✅ IMPLEMENTED](./recent-major-changes-august-october-2025.md#2-migration-tracking-system-implemented)
    - [3. Version Checking System ✅ IMPLEMENTED](./recent-major-changes-august-october-2025.md#3-version-checking-system-implemented)
    - [4. Web Crawling Enhancements ✅ IMPLEMENTED](./recent-major-changes-august-october-2025.md#4-web-crawling-enhancements-implemented)
    - [5. BMad Methodology Integration 🆕 INTEGRATED](./recent-major-changes-august-october-2025.md#5-bmad-methodology-integration-integrated)
    - [6. Frontend Architecture Improvements ✅ IMPLEMENTED](./recent-major-changes-august-october-2025.md#6-frontend-architecture-improvements-implemented)
  ...
  - [Enhancement Impact Analysis: Confluence Integration](./enhancement-impact-analysis-confluence-integration.md)
    ...
    - [Required Changes](./enhancement-impact-analysis-confluence-integration.md#required-changes)
      - [Backend Files (Implemented)](./enhancement-impact-analysis-confluence-integration.md#backend-files-implemented)
      ...
      - [Frontend Files (Future Phase)](./enhancement-impact-analysis-confluence-integration.md#frontend-files-future-phase)
  ...
  - [Summary of Current State (October 2025)](./summary-of-current-state-october-2025.md)
    - [What Was Implemented ✅](./summary-of-current-state-october-2025.md#what-was-implemented)
    - [What Was Planned but Not Implemented ❌](./summary-of-current-state-october-2025.md#what-was-planned-but-not-implemented)
