...
- [x] **Task 1: Create Migration File Structure** (AC: 1, 6)
  - [x] Create file `migration/0.1.0/901_add_confluence_pages.sql`
...
- [x] **Task 6: Self-Record Migration** (AC: 6)
  - [x] Add INSERT statement: `INSERT INTO archon_migrations (version, migration_name) VALUES ('0.1.0', '901_add_confluence_pages') ON CONFLICT DO NOTHING`
...
- Pattern: `INSERT INTO archon_migrations (version, migration_name) VALUES ('0.1.0', '901_add_confluence_pages') ON CONFLICT (version, migration_name) DO NOTHING`
...
**Migration File Path**: `migration/0.1.0/901_add_confluence_pages.sql`
...
└── 0.1.0/                       # Version-specific migrations
    ...
    └── 901_add_confluence_pages.sql  # THIS FILE (TO CREATE)
```
[Source: architecture/source-tree-and-module-organization.md#project-structure-actual-october-2025]
...
**Created Files:**
- `migration/0.1.0/901_add_confluence_pages.sql` - Complete migration SQL (157 lines)
...
- **When**: Developer creates 901_add_confluence_pages.sql
...
- **Then**: Record inserted with ('0.1.0', '901_add_confluence_pages') using ON CONFLICT DO NOTHING
